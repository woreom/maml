...
def main():
    ...
    mini_test = RottenImage(args.path, mode='test', n_way=args.n_way, k_shot=args.k_spt,
                             k_query=args.k_qry,
                             batchsz=args.batch//2, resize=args.imgsz)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--path', type=str, help='epoch number', default="/mnt/d/M3/Projects/okl/MAML-Pytorch/dataset/")
    argparser.add_argument('--batch', type=int, help='epoch number', default=10)
